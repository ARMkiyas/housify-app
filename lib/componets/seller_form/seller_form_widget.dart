                          ...
                          child: StreamBuilder<List<ProfessonsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ProfessonsRecord>
                                  idTypeProfessonsRecordList = snapshot.data!;
                              return FlutterFlowDropDown<IdTypes>(
                                ...
                                options: List<IdTypes>.from(IdTypes.values),
                                optionLabels:
                                    IdTypes.values.map((e) => e.name).toList(),
                                onChanged: (val) =>
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: _model.idTypeValue == IdTypes.PassPort
                                    ? 'Passport Number'
                                    : 'National Id Number',
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
