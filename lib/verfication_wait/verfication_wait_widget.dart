...
class VerficationWaitWidget extends StatefulWidget {
  const VerficationWaitWidget({super.key});

  @override
  State<VerficationWaitWidget> createState() => _VerficationWaitWidgetState();
}

class _VerficationWaitWidgetState extends State<VerficationWaitWidget>
    with TickerProviderStateMixin {
  late VerficationWaitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerficationWaitModel());
